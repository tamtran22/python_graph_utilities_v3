...
def read_1D_input(
    ...
    ##
    parent_id = _data_dict['Pare_ID']
    child_id = _data_dict['ID']
    x_end = _data_dict['x_end']
    y_end = _data_dict['y_end']
    z_end = _data_dict['z_end']
    length = _data_dict['Length']
    diameter = _data_dict['Diameter']
    generation = _data_dict['Gene']
    lobe = _data_dict['Lobe']
    flag = _data_dict['Flag']
